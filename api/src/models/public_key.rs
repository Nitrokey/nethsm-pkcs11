...
impl PublicKey {
    pub fn new(mechanisms: Vec<crate::models::KeyMechanism>, r#type: crate::models::KeyType, restrictions: crate::models::KeyRestrictions, key: crate::models::KeyPublicData, operations: i32) -> PublicKey {
        PublicKey {
            mechanisms,
            r#type,
