 ...
 */
func (a *DefaultApiService) ConfigLoggingGetExecute(r ApiConfigLoggingGetRequest) (LoggingConfig, *_nethttp.Response, error) {
	var (
 ...
 */
func (a *DefaultApiService) ConfigNetworkGetExecute(r ApiConfigNetworkGetRequest) (NetworkConfig, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @return TimeConfig
 */
func (a *DefaultApiService) ConfigTimeGetExecute(r ApiConfigTimeGetRequest) (TimeConfig, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 */
func (a *DefaultApiService) ConfigUnattendedBootGetExecute(r ApiConfigUnattendedBootGetRequest) (UnattendedBootConfig, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 */
func (a *DefaultApiService) HealthStateGetExecute(r ApiHealthStateGetRequest) (HealthStateData, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @return InfoData
 */
func (a *DefaultApiService) InfoGetExecute(r ApiInfoGetRequest) (InfoData, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @return []KeyItem
 */
func (a *DefaultApiService) KeysGetExecute(r ApiKeysGetRequest) ([]KeyItem, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiKeysKeyIDDecryptPostRequest) Execute() (DecryptData, *_nethttp.Response, error) {
 ...
 * @return DecryptData
 */
func (a *DefaultApiService) KeysKeyIDDecryptPostExecute(r ApiKeysKeyIDDecryptPostRequest) (DecryptData, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiKeysKeyIDSignPostRequest) Execute() (SignData, *_nethttp.Response, error) {
 ...
 * @return SignData
 */
func (a *DefaultApiService) KeysKeyIDSignPostExecute(r ApiKeysKeyIDSignPostRequest) (SignData, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiKeysPostRequest) Body(body PrivateKey) ApiKeysPostRequest {
	r.body = &body
	return r
}

func (r ApiKeysPostRequest) Execute() (KeyItem, *_nethttp.Response, error) {
 ...
 * @return KeyItem
 */
func (a *DefaultApiService) KeysPostExecute(r ApiKeysPostRequest) (KeyItem, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	if r.mechanisms != nil {
		localVarQueryParams.Add("mechanisms", parameterToString(*r.mechanisms, "csv"))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{"application/json"}
...
func (r ApiRandomPostRequest) Execute() (RandomData, *_nethttp.Response, error) {
 ...
 * @return RandomData
 */
func (a *DefaultApiService) RandomPostExecute(r ApiRandomPostRequest) (RandomData, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @return SystemInfo
 */
func (a *DefaultApiService) SystemInfoGetExecute(r ApiSystemInfoGetRequest) (SystemInfo, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiSystemRestorePostRequest) SystemTime(systemTime time.Time) ApiSystemRestorePostRequest {
	r.systemTime = &systemTime
	return r
}
func (r ApiSystemRestorePostRequest) Body(body map[string]interface{}) ApiSystemRestorePostRequest {
	r.body = &body
	return r
}
...
func (r ApiSystemUpdatePostRequest) Execute() (SystemUpdateData, *_nethttp.Response, error) {
 ...
 */
func (a *DefaultApiService) SystemUpdatePostExecute(r ApiSystemUpdatePostRequest) (SystemUpdateData, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @return []UserItem
 */
func (a *DefaultApiService) UsersGetExecute(r ApiUsersGetRequest) ([]UserItem, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @return UserData
 */
func (a *DefaultApiService) UsersUserIDGetExecute(r ApiUsersUserIDGetRequest) (UserData, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
