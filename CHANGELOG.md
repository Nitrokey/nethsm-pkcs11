...
- Updated CI pipeline to test with Fedora `42` and `43`.
- Add default derive for ObjectKind enum.
- Update bytes dependencies.

[2.0.1-rc.1]: https://github.com/Nitrokey/nethsm-pkcs11/releases/tag/v2.0.1-rc.1
[Full Changelog](https://github.com/Nitrokey/nethsm-pkcs11/compare/v2.0.0...v2.0.1-rc.1)
