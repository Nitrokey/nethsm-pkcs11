...
// 	case CKM_RSA_PKCS, CKM_ECDSA:
// 		return crypto.Hash(0), nil
// 	case CKM_MD5_RSA_PKCS, CKM_MD5:
// 		h = crypto.MD5
// 	case CKM_SHA1_RSA_PKCS_PSS, CKM_SHA1_RSA_PKCS, CKM_SHA_1, CKM_ECDSA_SHA1:
// 		h = crypto.SHA1
// 	case CKM_SHA256_RSA_PKCS_PSS, CKM_SHA256_RSA_PKCS, CKM_SHA256, CKM_ECDSA_SHA256:
// 		h = crypto.SHA256
// 	case CKM_SHA384_RSA_PKCS_PSS, CKM_SHA384_RSA_PKCS, CKM_SHA384, CKM_ECDSA_SHA384:
// 		h = crypto.SHA384
// 	case CKM_SHA512_RSA_PKCS_PSS, CKM_SHA512_RSA_PKCS, CKM_SHA512, CKM_ECDSA_SHA512:
// 		h = crypto.SHA512
// 	default:
// 		err = NewError("Mechanism.Sign", "mechanism not supported yet for hashing", CKR_MECHANISM_INVALID)
// 		return
// 	}
// 	return
// }
...
// 		if hashType == crypto.Hash(0) {
// 			err = NewError("Mechanism.Sign", "mechanism hash type is not supported with PSS padding", CKR_MECHANISM_INVALID)
// 		}
// 		hashFunc := hashType.New()
// 		_, err = hashFunc.Write(data)
// 		if err != nil {
...
// 		return
// 	default:
// 		err = NewError("Mechanism.Sign", "mechanism not supported yet for preparing", CKR_MECHANISM_INVALID)
// 		return
// 	}
// }
